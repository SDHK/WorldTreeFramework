...
namespace WorldTree
{
    public static class SystemListSendExtension
    {
        ...
        {
            foreach (ISendRule system in systems)
            {
                system.Invoke(self);
            }
        }
        ...
        {
            foreach (ISendRule<T1> system in systems)
            {
        ...
        {
            foreach (ISendRule<T1, T2> system in systems)
            {
        ...
        {
            foreach (ISendRule<T1, T2, T3> system in systems)
            {
        ...
        {
            foreach (ISendRule<T1, T2, T3, T4> system in systems)
            {
        ...
        {
            foreach (ISendRule<T1, T2, T3, T4, T5> system in systems)
            {
