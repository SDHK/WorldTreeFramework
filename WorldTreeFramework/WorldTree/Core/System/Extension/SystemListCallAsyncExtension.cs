...
namespace WorldTree
{
    public static class SystemListCallAsyncExtension
    {
        ...
        public static async TreeTask<OutT> CallAsync<OutT>(this List<IRule> systems, Node self)
        {
            ...
            foreach (ICallRuleAsync<OutT> system in systems)
            {
        ...
        {
            OutT outT = default(OutT);
            foreach (ICallRuleAsync<T1, OutT> system in systems)
            {
        ...
        {
            OutT outT = default(OutT);
            foreach (ICallRuleAsync<T1, T2, OutT> system in systems)
            {
        ...
        {
            OutT outT = default(OutT);
            foreach (ICallRuleAsync<T1, T2, T3, OutT> system in systems)
            {
        ...
        {
            OutT outT = default(OutT);
            foreach (ICallRuleAsync<T1, T2, T3, T4, OutT> system in systems)
            {
        ...
        {
            OutT outT = default(OutT);
            foreach (ICallRuleAsync<T1, T2, T3, T4, T5, OutT> system in systems)
            {
