...
* 
* 
* ICallSystem 继承 IRule
* 主要作用：统一 调用方法  OutT Invoke(Node self,T1 ar1, ...);
* 
* 
* CallSystemBase 则继承 RuleBase 
...
namespace WorldTree
{
    ...
    /// 调用系统接口
    /// </summary>
    public interface ICallSystem<OutT> : IRule
    {
    ...
    /// 调用系统接口
    /// </summary>
    public interface ICallSystem<T1, OutT> : IRule
    {
    ...
    /// 调用系统接口
    /// </summary>
    public interface ICallSystem<T1, T2, OutT> : IRule
    {
    ...
    /// 调用系统接口
    /// </summary>
    public interface ICallSystem<T1, T2, T3, OutT> : IRule
    {
    ...
    /// 调用系统接口
    /// </summary>
    public interface ICallSystem<T1, T2, T3, T4, OutT> : IRule
    {
    ...
    /// 调用系统接口
    /// </summary>
    public interface ICallSystem<T1, T2, T3, T4, T5, OutT> : IRule
    {
    ...
    /// 调用系统抽象基类
    /// </summary>
    public abstract class CallSystemBase<S, E, OutT> : RuleBase<E, S>, ICallSystem<OutT>
    where E : Node
    ...
    /// 调用系统抽象基类
    /// </summary>
    public abstract class CallSystemBase<S, E, T1, OutT> : RuleBase<E, S>, ICallSystem<T1, OutT>
    where E : Node
    ...
    /// 调用系统抽象基类
    /// </summary>
    public abstract class CallSystemBase<S, E, T1, T2, OutT> : RuleBase<E, S>, ICallSystem<T1, T2, OutT>
    where E : Node
    ...
    /// 调用系统抽象基类
    /// </summary>
    public abstract class CallSystemBase<S, E, T1, T2, T3, OutT> : RuleBase<E, S>, ICallSystem<T1, T2, T3, OutT>
    where E : Node
    ...
    /// 调用系统抽象基类
    /// </summary>
    public abstract class CallSystemBase<S, E, T1, T2, T3, T4, OutT> : RuleBase<E, S>, ICallSystem<T1, T2, T3, T4, OutT>
    where E : Node
    ...
    /// 调用系统抽象基类
    /// </summary>
    public abstract class CallSystemBase<S, E, T1, T2, T3, T4, T5, OutT> : RuleBase<E, S>, ICallSystem<T1, T2, T3, T4, T5, OutT>
    where E : Node
