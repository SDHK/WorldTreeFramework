...
* 
* 
* ISendSystem 继承 IEntitySystem
* 主要作用：统一 调用方法 Invoke(Entity self,T1 ar1, ...);
* 
* 
* SendSystemBase 则继承 SystemBase 
...
namespace WorldTree
{
    ...
    /// 发送系统接口
    /// </summary>
    public interface ISendSystem : IEntitySystem
    {
    ...
    /// 发送系统接口
    /// </summary>
    public interface ISendSystem<T1> : IEntitySystem
    {
    ...
    /// 发送系统接口
    /// </summary>
    public interface ISendSystem<T1, T2> : IEntitySystem
    {
    ...
    /// 发送系统接口
    /// </summary>
    public interface ISendSystem<T1, T2, T3> : IEntitySystem
    {
    ...
    /// 发送系统接口
    /// </summary>
    public interface ISendSystem<T1, T2, T3, T4> : IEntitySystem
    {
    ...
    /// 发送系统接口
    /// </summary>
    public interface ISendSystem<T1, T2, T3, T4, T5> : IEntitySystem
    {
