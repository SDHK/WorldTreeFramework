...
namespace WorldTree
{
    public static class SendRuleExtension
    {
        ...
        public static bool TrySendRule<R>(this INode self, R defaultRule)
        where R : ISendRule
        {
        ...
        public static void SendRule<R>(this INode self, R defaultRule = default)
            where R : ISendRule
        {
            self.TrySendRule(defaultRule);
        }
        public static void SendRule<R, T1>(this INode self, R defaultRule, T1 arg1)
           where R : ISendRule<T1>
        {
            self.TrySendRule(defaultRule, arg1);
        }
        public static void SendRule<R, T1, T2>(this INode self, R defaultRule, T1 arg1, T2 arg2)
           where R : ISendRule<T1, T2>
        {
            self.TrySendRule(defaultRule, arg1, arg2);
        }
        public static void SendRule<R, T1, T2, T3>(this INode self, R defaultRule, T1 arg1, T2 arg2, T3 arg3)
           where R : ISendRule<T1, T2, T3>
        {
            self.TrySendRule(defaultRule, arg1, arg2, arg3);
        }
        public static void SendRule<R, T1, T2, T3, T4>(this INode self, R defaultRule, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
         where R : ISendRule<T1, T2, T3, T4>
        {
            self.TrySendRule(defaultRule, arg1, arg2, arg3, arg4);
        }
        public static void SendRule<R, T1, T2, T3, T4, T5>(this INode self, R defaultRule, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
         where R : ISendRule<T1, T2, T3, T4, T5>
        {
