...
namespace WorldTree
{
    ...
    {
        public static async AsyncTask<bool> TrySendAsync(this Entity self) => await self.TrySendAsyncSystem<ICallSystem<AsyncTask>>();
        public static async AsyncTask<bool> TrySendAsync<T1>(this Entity self, T1 arg1) => await self.TrySendAsyncSystem<ICallSystem<T1, AsyncTask>, T1>(arg1);
        public static async AsyncTask<bool> TrySendAsync<T1, T2>(this Entity self, T1 arg1, T2 arg2) => await self.TrySendAsyncSystem<ICallSystem<T1, T2, AsyncTask>, T1, T2>(arg1, arg2);
        public static async AsyncTask<bool> TrySendAsync<T1, T2, T3>(this Entity self, T1 arg1, T2 arg2, T3 arg3) => await self.TrySendAsyncSystem<ICallSystem<T1, T2, T3, AsyncTask>, T1, T2, T3>(arg1, arg2, arg3);
        public static async AsyncTask<bool> TrySendAsync<T1, T2, T3, T4>(this Entity self, T1 arg1, T2 arg2, T3 arg3, T4 arg4) => await self.TrySendAsyncSystem<ICallSystem<T1, T2, T3, T4, AsyncTask>, T1, T2, T3, T4>(arg1, arg2, arg3, arg4);
