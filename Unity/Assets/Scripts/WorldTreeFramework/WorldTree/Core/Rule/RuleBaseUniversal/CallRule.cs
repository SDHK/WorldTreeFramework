...
namespace WorldTree
{
	...
	///// 通用调用法则接口
	///// </summary>
	//public interface ICallRule<OutT> : ICallRuleBase<OutT> { }
	///// <summary>
	///// 通用调用法则接口
	///// </summary>
	//public interface ICallRule<T1, OutT> : ICallRuleBase<T1, OutT> { }
	///// <summary>
	///// 通用调用法则接口
	///// </summary>
	//public interface ICallRule<T1, T2, OutT> : ICallRuleBase<T1, T2, OutT> { }
	///// <summary>
	///// 通用调用法则接口
	///// </summary>
	//public interface ICallRule<T1, T2, T3, OutT> : ICallRuleBase<T1, T2, T3, OutT> { }
	///// <summary>
	///// 通用调用法则接口
	///// </summary>
	//public interface ICallRule<T1, T2, T3, T4, OutT> : ICallRuleBase<T1, T2, T3, T4, OutT> { }
	///// <summary>
	///// 通用调用法则接口
	///// </summary>
	//public interface ICallRule<T1, T2, T3, T4, T5, OutT> : ICallRuleBase<T1, T2, T3, T4, T5, OutT> { }
