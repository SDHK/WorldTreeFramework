...
namespace WorldTree
{
	...
	/// <summary>
	/// 全局法则执行器：请使用 RuleBroadcast<R>
	/// </summary>
	public partial class RuleBroadcaster<R> : RuleGroupExecutor, INodeListener, RuleBroadcast<IGlobalRule>
	...
	public static class RuleBroadcasterRule
	{
			...
			where R : IGlobalRule
		{
			...
			{
				self.GetBaseRule<RuleBroadcaster<R>, RuleGroupExecutor, Add>().Send(self);
