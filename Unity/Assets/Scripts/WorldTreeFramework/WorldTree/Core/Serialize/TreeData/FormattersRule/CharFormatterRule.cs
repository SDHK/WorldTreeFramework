...
namespace WorldTree.TreeDataFormatters
{
	public static class CharFormatterRule
	{
		...
		class Serialize : TreeDataSerializeRule<TreeDataByteSequence, char>
		{
			protected override void Execute(TreeDataByteSequence self, ref object value)
			{
				self.WriteType(typeof(char));
				self.WriteUnmanaged((char)value);
			}
		}

		class Deserialize : TreeDataDeserializeRule<TreeDataByteSequence, char>
		{
