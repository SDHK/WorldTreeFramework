...
namespace WorldTree.TreeDataFormatters
{
	public static class UshortFormatterRule
	{
		...
		class Serialize : TreeDataSerializeRule<TreeDataByteSequence, ushort>
		{
			protected override void Execute(TreeDataByteSequence self, ref object value)
			{
				self.WriteType(typeof(ushort));
				self.WriteUnmanaged((ushort)value);
			}
		}

		class Deserialize : TreeDataDeserializeRule<TreeDataByteSequence, ushort>
		{
