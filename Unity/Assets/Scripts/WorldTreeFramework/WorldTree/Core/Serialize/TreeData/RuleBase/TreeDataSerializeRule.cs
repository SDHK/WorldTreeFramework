...
namespace WorldTree
{
	...
	///// 树数据序列化法则
	///// </summary>
	//public abstract class TreeDataSerializeRule<GT> : TreeDataSerializeRuleBase<TreeDataByteSequence, TreeDataSerialize, GT, SerializedTypeMode>
	//{ }

	///// <summary>
	///// 树数据反序列化法则
	///// </summary>
	//public abstract class TreeDataDeserializeRule<GT> : TreeDataSerializeRuleBase<TreeDataByteSequence, TreeDataDeserialize, GT, int>
	//{ }
