namespace WorldTree
{
	...
	/// 步骤机测试 
	/// </summary>
	public partial class StepMachineTest : Node
		...
		, AsRule<Update>
	{
		...
		[NodeRule(nameof(AwakeRule<StepMachineTest>))]
		private static void OnAwakeRule(StepMachineTest self)
		{
		...
		private static void OnUpdateRule(StepMachineTest self)
		{
