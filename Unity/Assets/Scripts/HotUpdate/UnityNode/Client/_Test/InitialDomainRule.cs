...
namespace WorldTree
{
	...
	///// a
	///// </summary>
	//public partial class InitialTest<T>
	//{
	//	/// <summary>
	//	/// a
	//	/// </summary>
	//	[NodeRule(nameof(AwakeRule<InitialTest<T>>))]
	//	private static void OnAwakeRule(InitialTest<T> self)
	//	{
	//		//self.Log($"初始域唤醒123456AAA！！!");
	//	}
	//	///// <summary>
	//	///// a
	//	///// </summary>
	//	////[RuleSwitch(nameof(OnGuiUpdate2Rule), nameof(self.Id), 2L)]
	//	//[NodeRule(nameof(GuiUpdateRule<InitialTest<T>>))]
	//	//private static void OnGuiUpdate2Rule(InitialDomain<T> self)
	//	//{
	//	//}
	//}
