...
namespace WorldTree
{
    public static partial class TreeTweenRule
    {
        ...
        {
            public override void OnEvent(TreeTweenBase self, TaskState state)
            {
                switch (state)
                {
        ...
        {
            return self.m_Curve.CallRule((ICurveEvaluateRule)null, self.GetTimeScale(deltaTime), out float _);
        }
