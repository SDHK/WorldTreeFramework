...
namespace WorldTree
{
    ...
    public static partial class TreeValueBaseRule
    {
            ...
            where N : class, INode, AsRule<ISendRuleBase<T1>>
        {
            ...
            self.m_ValueChange.Add(eventNode, default(IValueChangeRuleEvent<T1>));
        }
        ...
        {
            if (self.m_ValueChange is null) self.AddChild(out self.m_ValueChange);
            self.m_ValueChange.Add(treeValue, default(IValueChangeRuleEvent<T1>));
        }
            ...
            where T2 : IEquatable<T2>
        {
            ...
            self.m_ValueChange.Add(treeValue, default(IValueChangeRuleEvent<T1>));
            treeValue.m_ValueChange.Add(self, default(IValueChangeRuleEvent<T2>));
        }
    }
