...
namespace WorldTree
{
    public static class NodeComponentRule
    {
            ...
            where T : class, INode, ComponentOf<N>, AsRule<IAwakeRule>
        {
            ...
            {
                Component.SendRule(NullType<IAwakeRule>.Null);
                self.Core.AddNode(Component);
            }
            return Component;
        }
            ...
            where T : class, INode, ComponentOf<N>, AsRule<IAwakeRule<T1>>
        {
            if (self.TryAddComponent(out Component))
            {
                Component.SendRule(NullType<IAwakeRule<T1>>.Null, arg1);
                self.Core.AddNode(Component);
            }
            return Component;
        }
            ...
            where T : class, INode, ComponentOf<N>, AsRule<IAwakeRule<T1, T2>>
        {
            if (self.TryAddComponent(out Component))
            {
                Component.SendRule(NullType<IAwakeRule<T1, T2>>.Null, arg1, arg2);
                self.Core.AddNode(Component);
            }
            return Component;
        }
            ...
            where T : class, INode, ComponentOf<N>, AsRule<IAwakeRule<T1, T2, T3>>
        {
            if (self.TryAddComponent(out Component))
            {
                Component.SendRule(NullType<IAwakeRule<T1, T2, T3>>.Null, arg1, arg2, arg3);
                self.Core.AddNode(Component);
            }
            return Component;
        }
            ...
            where T : class, INode, ComponentOf<N>, AsRule<IAwakeRule<T1, T2, T3, T4>>
        {
            if (self.TryAddComponent(out Component))
            {
                Component.SendRule(NullType<IAwakeRule<T1, T2, T3, T4>>.Null, arg1, arg2, arg3, arg4);
                self.Core.AddNode(Component);
            }
            return Component;
        }
            ...
            where T : class, INode, ComponentOf<N>, AsRule<IAwakeRule<T1, T2, T3, T4, T5>>
        {
            if (self.TryAddComponent(out Component))
            {
                Component.SendRule(NullType<IAwakeRule<T1, T2, T3, T4, T5>>.Null, arg1, arg2, arg3, arg4, arg5);
                self.Core.AddNode(Component);
            }
            return Component;
        }
