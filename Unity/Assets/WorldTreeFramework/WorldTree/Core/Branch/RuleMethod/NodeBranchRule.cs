namespace WorldTree
{
	public static class NodeBranchRule
	{
		...
		/// 添加节点
		/// </summary>
		public static INode AddNode<B, K, T1, T2, T3, T4, T5>(this INode self, K key, long type, out INode node, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, bool isPool = true)
			where B : class, IBranch<K>
